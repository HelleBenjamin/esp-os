...
#define helpMessage "Commands: help, sysinfo, echo <text>, pinset <pin> <value>, pinread <pin>, calculator, my_program, ram <from> <to>, reboot, pinreset, direct_syscall or dscall"
